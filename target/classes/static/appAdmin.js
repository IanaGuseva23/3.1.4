...
on(document, 'click', '.eBtn', e => {
    ...
    const lastnameMod = line.children[2].innerHTML
    const ageMod = line.children[3].innerHTML
    const emailMod = line.children[4].innerHTML
    const passMod = line.children[5].innerHTML
    const rolesMod = line.children[6].innerHTML


    Id.value = idMod
    Name.value = nameMod
    Lastname.value = lastnameMod
    ageEdit.value = ageMod
    email.value - emailMod
